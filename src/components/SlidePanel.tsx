...
export default function SlidePanel({ open, onClose, title, children }: SlidePanelProps) {
  return (
    <>
      ...
      <div
        className={`fixed top-14 right-0 h-[calc(100vh-3.5rem)] w-full sm:w-[400px] bg-card border-l border-border shadow-lg z-20 transition-transform duration-300 ease-in-out ${
