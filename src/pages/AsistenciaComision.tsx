...
type EstadoAsistencia = "presente" | "ausente" | "justificada" | null;
...
const clasesPorEstado: Record<string, string> = {
  ...
  justificada: "bg-sky-100 text-sky-800 border-sky-200",
};
...
export default function AsistenciaComision() {
  ...
  // asistencia[estudianteId][eventoId] = EstadoAsistencia
  ...
  if (loading) {
    return (
      <p className="text-muted-foreground text-sm p-6">Cargando asistencia...</p>
    );
  }
